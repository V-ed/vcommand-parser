...
describe('default option prefix with definitions', () => {
	describe('Messages with basic options', () => {
		describe('options do accept', () => {
			it('should contain one defined long option', () => {
				const testCommander = VCommandParser.parseLazy('!mycommand --long');
				
				testCommander.setOptionDefinitions(optionDefinitions);
			...
			it('should contain one defined short option', () => {
				const testCommander = VCommandParser.parseLazy('!mycommand -s');
			...
			it('should contain one defined long option with content', () => {
				const testCommander = VCommandParser.parseLazy('!mycommand --long content');
			...
			it('should contain one defined short option with content', () => {
				const testCommander = VCommandParser.parseLazy('!mycommand -s content');
		...
		describe('options do not accept', () => {
			it('should contain one defined long option', () => {
				...
				testCommander.setOptionDefinitions(optionDefinitionsNoContent);
	...
	describe('retrieving options from command parser', () => {
		it('should retrieve long option by short call', () => {
			...
			testCommander.setOptionDefinitions(optionDefinitionsMultipleCalls);
